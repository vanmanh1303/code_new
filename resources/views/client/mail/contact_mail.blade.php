                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td class="es-p15t" align="left">
                                                                    <p style="color: #999999">{{ $data['noi_dung'] }}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-p15t" align="left">
                                                                    <p style="color: #999999">Khách hàng,</p>
                                                                    <p style="color: #999999">{{ $data['ho_va_ten'] }}
                                                                    </p>
                                                                    {{-- <p style="color: #999999">{{ $data['email'] }}</p> --}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="560" valign="top" align="center">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            role="presentation">
                                                            <tr>
                                                                <td class="es-p10t es-p15r es-p15l" align="center">
                                                                    <p style="font-size: 20px;line-height: 30px">
                                                                        {{ $data['so_dien_thoai'] }}
                                                                    </p>
                                                                    <p style="font-size: 14px">{{ $data['email'] }}</p>
                                                                    {{-- <p style="font-size: 14px">dia_chi 101 Southwest
                                                                        Blvd, Kansas City, MO 64108, USA</p> --}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
